...
st.write(
    """This app uses 6 input to predict th species of penguin using a model built on the palmer Penguin 
...
if penguin_file is None:
    ...
    st.write(
        f"""We trained a random Forest model on these data, it has a score of {score}! 
        Use the inputd below to try out the model"""
    )
